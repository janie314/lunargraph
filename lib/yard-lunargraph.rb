...
module Lunargraph
  ...
  # for yardocs. It's only used for Lunargraph API maps.
...
YARD::Tags::Library.define_directive('domain', :with_types, Lunargraph::DomainDirective)
# Define an @!override directive for overriding method tags
YARD::Tags::Library.define_directive('override', :with_name, Lunargraph::DomainDirective)
