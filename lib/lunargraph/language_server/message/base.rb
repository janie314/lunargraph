  ...
  module LanguageServer
    module Message
      class Base
        ...
        # @param host [Lunargraph::LanguageServer::Host]
        # @param request [Hash]
        ...
        # @param code [Integer] See Lunargraph::LanguageServer::ErrorCodes
        ...
        def send_response
          ...
          if host.cancel?(id)
            ...
            Lunargraph::Logging.logger.info "Cancelled response to #{method}"
            set_result nil
            set_error ErrorCodes::REQUEST_CANCELLED, 'cancelled by client'
          else
            Lunargraph::Logging.logger.info "Sending response to #{method}"
          end
          response = {
            jsonrpc: '2.0',
            id: id
          ...
          Lunargraph.logger.debug envelope
          host.queue envelope
          host.clear id
        end
      end
