...
require 'lunargraph/converters/dl'
require 'lunargraph/converters/dt'
require 'lunargraph/converters/dd'
require 'lunargraph/converters/misc'
    ...
    module Documenting
      ...
      class DocSection
        ...
        def to_s
          ...
          ReverseMarkdown.convert unescape_brackets(Kramdown::Document.new(escape_brackets(@plaintext),
                                                                           input: 'GFM').to_html)
        end
