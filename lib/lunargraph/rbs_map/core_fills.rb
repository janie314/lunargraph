...
@yieldparam_single_parameter
      ...
      errno = Lunargraph::Pin::Namespace.new(name: 'Errno')
      errnos = []
      Errno.constants.each do |const|
        errnos.push Lunargraph::Pin::Namespace.new(type: :class, name: const.to_s, closure: errno)
        errnos.push Lunargraph::Pin::Reference::Superclass.new(closure: errnos.last, name: 'SystemCallError')
      end
      ERRNOS = errnos
