    ...
    class Mapper
      module ToMethod
        ...
        def self.make code_object, name = nil, scope = nil, visibility = nil, closure = nil, spec = nil
          closure ||= Lunargraph::Pin::Namespace.new(
