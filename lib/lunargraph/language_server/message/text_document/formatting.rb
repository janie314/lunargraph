    ...
    module Message
      module TextDocument
        class Formatting < Base
          include Lunargraph::Diagnostics::RubocopHelpers
          ...
          def process
            ...
            set_error(Lunargraph::LanguageServer::ErrorCodes::INTERNAL_ERROR, "[#{e.class}] #{e.message}")
          end
          ...
          def log_corrections(corrections)
            ...
            Lunargraph.logger.info('Formatting result:')
            corrections.each_line do |line|
              next if line.strip.empty?
              Lunargraph.logger.info(line.strip)
            end
          end
