        ...
        class SendNode < Parser::NodeProcessor::Base
          ...
          def process
            if node.children[0].nil?
              if %i[private public protected].include?(node.children[1])
                process_visibility
              elsif node.children[1] == :module_function
                process_module_function
              elsif %i[attr_reader attr_writer attr_accessor].include?(node.children[1])
                process_attribute
          ...
          def process_attribute
            node.children[2..].each do |a|
              ...
              next unless node.children[1] == :attr_writer || node.children[1] == :attr_accessor
              pins.push Lunargraph::Pin::Method.new(
                location: loc,
                closure: clos,
                name: "#{a.children[0]}=",
          ...
          def process_private_constant
            return unless node.children[2] && (node.children[2].type == :sym || node.children[2].type == :str)
