...
module Lunargraph
  module LanguageServer
    module Message
      module Workspace
        class DidChangeWatchedFiles < Lunargraph::LanguageServer::Message::Base
          CREATED = 1
          CHANGED = 2
          DELETED = 3
          ...
          def process
            ...
            params['changes'].each do |change|
              ...
              when DELETED
                ...
                set_error Lunargraph::LanguageServer::ErrorCodes::INVALID_PARAMS,
            ...
            # Force host to catalog libraries after file changes (see castwide/lunargraph#139)
